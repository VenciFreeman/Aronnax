...
import sys
##########################################################
##this part is to ensure the input argv at least 4
if len(sys.argv) != 4:
    print('Usage:')
...
#import torchsnooper
# Training settings
modeltype = sys.argv[1]+'()' ##the second argv models.py
...
def train(epoch):
    ...
    for batch_idx, (data, target) in enumerate(train_loader):
        ...
        loss = region_loss(output, target)##region loss compute in cuda.
        loss.backward()
        optimizer.step()
