...
#import torchsnooper
#@torchsnooper.snoop()
#this function could run in the last stage of the detection work
...
##########################################################        
        ...
        print('%d: nGT %d, recall %d,  loss: x %f, y %f, w %f, h %f, conf %f, total %f' % (self.seen, nGT, nCorrect, loss_x.item(), loss_y.item(), loss_w.item(), loss_h.item(), loss_conf.item(),  loss.item()))
